...
module.exports = {
  ...
  head: {
    ...
    title: brand.crypto.name,
    meta: [
      { charset: 'utf-8' },
      { name: 'viewport', content: 'width=device-width, initial-scale=1' },
      { name: 'description', content: brand.crypto.desc },
      ...
      { property: 'og:title', content: brand.crypto.projectName },
      { property: 'og:description', content: brand.crypto.desc },
      { name: 'twitter:site', content: brand.crypto.url },
      { name: 'twitter:card', content: 'summary_large_image' },
      { name: 'twitter:image', content: brand.crypto.img },
      { property: 'og:image', content: brand.crypto.img },

<template>
  <div class="page-wrap contact">
    ...
    <v-container class="inner-wrap max-md">
      <v-btn :href="routeLink.crypto.home" icon class="backtohome">
            ...
            <v-form ref="form" v-model="valid">
              <v-row class="spacing6">
                <v-col cols="12" sm="6" class="px-6">
                  <v-text-field v-model="name" :rules="nameRules" :label="$t('common.form_name')" filled required />
                </v-col>
                <v-col cols="12" sm="6" class="px-6">
                  <v-text-field v-model="email" :rules="emailRules" :label="$t('common.form_email')" filled required />
                </v-col>
                <v-col cols="12" sm="6" class="px-6">
                  <v-text-field v-model="phone" :label="$t('common.form_phone')" filled />
                </v-col>
                <v-col cols="12" sm="6" class="px-6">
                  <v-text-field v-model="company" :label="$t('common.form_company')" filled />
                </v-col>
                <v-col cols="12" class="px-6">
                  <v-textarea v-model="message" rows="6" filled :label="$t('common.form_message')" />
                </v-col>
              </v-row>
              <div class="btn-area flex">
                <div class="form-control-label">
                  <v-checkbox v-model="checkbox" color="secondary" :rules="[v => !!v || 'You must agree to continue!']" :label="$t('common.form_terms')" required />
                  <span>
                    <a href="#" class="link">
                ...
                <v-btn :block="isMobile" color="secondary" @click="validate" large>
                  {{ $t('common.form_send') }}
                </v-btn>
              </div>
            </v-form>
